...
tar -a -c -f "%ZIP_NAME%" .github assets src i18n Cargo.toml Cargo.lock build.rs bridge scripts packager vcpkg.json app.manifest index.html donations*.txt CHANGELOG* README*.md
