...
LangString assocTitle ${LANG_UKRAINIAN} "File associations"
LangString assocSubtitle ${LANG_SERBIAN} "Izaberite da li zelite da povezete podrzane tipove datoteka sa ${PRODUCTNAME}."
LangString assocSubtitle ${LANG_UKRAINIAN} "Choose whether to associate supported file types with ${PRODUCTNAME}."
LangString assocCheckbox ${LANG_SERBIAN} "Povezi podrzane tipove datoteka sa ${PRODUCTNAME}"
LangString assocCheckbox ${LANG_UKRAINIAN} "Associate supported file types with ${PRODUCTNAME}"
LangString ctxMenuCheckbox ${LANG_SERBIAN} "Dodaj 'Otvori pomocu ${PRODUCTNAME}' u kontekstni meni"
LangString ctxMenuCheckbox ${LANG_UKRAINIAN} "Add 'Open with ${PRODUCTNAME}' to the context menu"
LangString ctxMenuLabel ${LANG_SERBIAN} "Otvori pomocu ${PRODUCTNAME}"
LangString ctxMenuLabel ${LANG_UKRAINIAN} "Open with ${PRODUCTNAME}"
LangString older ${LANG_SERBIAN} "starija"
LangString older ${LANG_UKRAINIAN} "older"
LangString unknown ${LANG_SERBIAN} "nepoznata"
LangString unknown ${LANG_UKRAINIAN} "unknown"
LangString alreadyInstalledLong ${LANG_SERBIAN} "${PRODUCTNAME} je vec instaliran. Izaberite operaciju koju zelite da izvrsite."
LangString alreadyInstalledLong ${LANG_UKRAINIAN} "${PRODUCTNAME} is already installed. Choose the operation to perform."
LangString addOrReinstall ${LANG_SERBIAN} "Popravi ili ponovo instaliraj ${PRODUCTNAME}"
LangString addOrReinstall ${LANG_UKRAINIAN} "Repair or reinstall ${PRODUCTNAME}"
LangString uninstallApp ${LANG_SERBIAN} "Deinstaliraj ${PRODUCTNAME}"
LangString uninstallApp ${LANG_UKRAINIAN} "Uninstall ${PRODUCTNAME}"
LangString alreadyInstalled ${LANG_SERBIAN} "Aplikacija je vec instalirana"
LangString alreadyInstalled ${LANG_UKRAINIAN} "Application already installed"
LangString chooseMaintenanceOption ${LANG_SERBIAN} "Izaberite zeljenu opciju odrzavanja."
LangString chooseMaintenanceOption ${LANG_UKRAINIAN} "Choose the maintenance option you want."
LangString olderOrUnknownVersionInstalled ${LANG_SERBIAN} "Instalirana je starija ili nepoznata verzija ${PRODUCTNAME}."
LangString olderOrUnknownVersionInstalled ${LANG_UKRAINIAN} "An older or unknown version of ${PRODUCTNAME} is installed."
LangString uninstallBeforeInstalling ${LANG_SERBIAN} "Deinstalirajte je pre instalacije ove verzije."
LangString uninstallBeforeInstalling ${LANG_UKRAINIAN} "Uninstall it before installing this version."
LangString dontUninstall ${LANG_SERBIAN} "Ne deinstaliraj"
LangString dontUninstall ${LANG_UKRAINIAN} "Do not uninstall"
LangString choowHowToInstall ${LANG_SERBIAN} "Izaberite nacin instalacije."
LangString choowHowToInstall ${LANG_UKRAINIAN} "Choose how you want to install."
LangString newerVersionInstalled ${LANG_SERBIAN} "Novija verzija ${PRODUCTNAME} je vec instalirana."
LangString newerVersionInstalled ${LANG_UKRAINIAN} "A newer version of ${PRODUCTNAME} is already installed."
LangString dontUninstallDowngrade ${LANG_SERBIAN} "Ne deinstaliraj (otkazi)"
LangString dontUninstallDowngrade ${LANG_UKRAINIAN} "Do not uninstall (cancel)"
LangString unableToUninstall ${LANG_SERBIAN} "Nije moguce deinstalirati. Zatvorite ${PRODUCTNAME} i pokusajte ponovo."
LangString unableToUninstall ${LANG_UKRAINIAN} "Unable to uninstall. Please close ${PRODUCTNAME} and try again."
LangString createDesktop ${LANG_SERBIAN} "Napravi precicu na radnoj povrsini"
LangString createDesktop ${LANG_UKRAINIAN} "Create a desktop shortcut"
LangString appRunningOkKill ${LANG_SERBIAN} "${PRODUCTNAME} je pokrenut. Zatvoriti sada?"
LangString appRunningOkKill ${LANG_UKRAINIAN} "${PRODUCTNAME} is running. Close it now?"
LangString appRunning ${LANG_SERBIAN} "${PRODUCTNAME} je pokrenut."
LangString appRunning ${LANG_UKRAINIAN} "${PRODUCTNAME} is running."
LangString failedToKillApp ${LANG_SERBIAN} "Nije uspelo zatvaranje ${PRODUCTNAME}."
LangString failedToKillApp ${LANG_UKRAINIAN} "Failed to close ${PRODUCTNAME}."
{{/if}}
